...
- **Interactive shell** — `awssso` drops into a REPL with built-in Tab completion, ↑↓ history, and Backspace — no setup required; type commands without the `awssso` prefix
